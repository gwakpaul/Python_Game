...
class PongBounceStage(Stage):
    ...
    def __init__(
        ...
        self.paddle_y = 0.0          # 실제 패들 위치(float)
        self.paddle_target_y = 0.0   # 목표 위치(float)
